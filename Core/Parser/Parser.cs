...
using System.Linq;
using static TypeScriptASTCore.Core.Parser.Core;
using static TypeScriptASTCore.Core.Parser.Scanner;
using static TypeScriptASTCore.Core.Parser.Ts;
using static TypeScriptASTCore.Core.Parser.Utilities;
...
namespace TypeScriptASTCore.Core.Parser
{
    public class Parser
    {
        ...
        public SourceFile ParseSourceFileWorker(string fileName, ScriptTarget languageVersion, bool setParentNodes, ScriptKind scriptKind)
        {
            ...
            SourceFile.Statements = ParseList2(Types.ParsingContext.SourceElements, ParseStatement);
        ...
        public bool IsListElement(ParsingContext parsingContext, bool inErrorRecovery)
        {
            ...
            {
                case Types.ParsingContext.SourceElements:
                case Types.ParsingContext.BlockStatements:
                case Types.ParsingContext.SwitchClauseStatements:
                ...
                case Types.ParsingContext.SwitchClauses:

                    return Token() == SyntaxKind.CaseKeyword || Token() == SyntaxKind.DefaultKeyword;
                case Types.ParsingContext.TypeMembers:

                    return LookAhead(IsTypeMemberStart);
                case Types.ParsingContext.ClassMembers:
                ...
                case Types.ParsingContext.EnumMembers:

                    // Include open bracket computed properties. This technically also lets in indexers,
                    // which would be a candidate for improved error reporting.
                    return Token() == SyntaxKind.OpenBracketToken || IsLiteralPropertyName();
                case Types.ParsingContext.ObjectLiteralMembers:
                ...
                case Types.ParsingContext.RestProperties:

                    return IsLiteralPropertyName();
                case Types.ParsingContext.ObjectBindingElements:

                    return Token() == SyntaxKind.OpenBracketToken || Token() == SyntaxKind.DotDotDotToken || IsLiteralPropertyName();
                case Types.ParsingContext.HeritageClauseElement:
                ...
                //goto caseLabel12;
                case Types.ParsingContext.VariableDeclarations:
                    //caseLabel12:
                    return IsIdentifierOrPattern();
                case Types.ParsingContext.ArrayBindingElements:

                    return Token() == SyntaxKind.CommaToken || Token() == SyntaxKind.DotDotDotToken || IsIdentifierOrPattern();
                case Types.ParsingContext.TypeParameters:

                    return IsIdentifier();
                case Types.ParsingContext.ArgumentExpressions:
                case Types.ParsingContext.ArrayLiteralMembers:

                    return Token() == SyntaxKind.CommaToken || Token() == SyntaxKind.DotDotDotToken || IsStartOfExpression();
                case Types.ParsingContext.Parameters:

                    return IsStartOfParameter();
                case Types.ParsingContext.TypeArguments:
                case Types.ParsingContext.TupleElementTypes:

                    return Token() == SyntaxKind.CommaToken || IsStartOfType();
                case Types.ParsingContext.HeritageClauses:

                    return IsHeritageClause();
                case Types.ParsingContext.ImportOrExportSpecifiers:

                    return TokenIsIdentifierOrKeyword(Token());
                case Types.ParsingContext.JsxAttributes:

                    return TokenIsIdentifierOrKeyword(Token()) || Token() == SyntaxKind.OpenBraceToken;
                case Types.ParsingContext.JsxChildren:

                    return true;
                case Types.ParsingContext.JSDocFunctionParameters:
                case Types.ParsingContext.JSDocTypeArguments:
                case Types.ParsingContext.JSDocTupleTypes:

                    return JsDocParser.IsJsDocType();
                case Types.ParsingContext.JSDocRecordMembers:
        ...
        public TypeReferenceNode ParseTypeReference()
        {
            ...
            if (!Scanner.HasPrecedingLineBreak() && Token() == SyntaxKind.LessThanToken)
            {
                ...
                node.TypeArguments = ParseBracketedList(Types.ParsingContext.TypeArguments, ParseType, SyntaxKind.LessThanToken, SyntaxKind.GreaterThanToken);
            }
        ...
        public NodeArray<TypeParameterDeclaration> ParseTypeParameters()
        {
            if (Token() == SyntaxKind.LessThanToken)
            {
                ...
                return ParseBracketedList(Types.ParsingContext.TypeParameters, ParseTypeParameter, SyntaxKind.LessThanToken, SyntaxKind.GreaterThanToken);
            }
            return null;
        }
        ...
        public NodeArray<ParameterDeclaration> ParseParameterList(bool yieldContext, bool awaitContext, bool requireCompleteParameterList)
        {
            if (ParseExpected(SyntaxKind.OpenParenToken))
            {
                ...
                var result = ParseDelimitedList(Types.ParsingContext.Parameters, ParseParameter);
        ...
        public IndexSignatureDeclaration ParseIndexSignatureDeclaration(int fullStart, NodeArray<Decorator> decorators, NodeArray<Modifier> modifiers)
        {
            ...
            node.Parameters = ParseBracketedList(Types.ParsingContext.Parameters, ParseParameter, SyntaxKind.OpenBracketToken, SyntaxKind.CloseBracketToken);
        ...
        public NodeArray<ITypeElement> ParseObjectTypeMembers()
        {
            ...
            if (ParseExpected(SyntaxKind.OpenBraceToken))
            {
                ...
                members = ParseList(Types.ParsingContext.TypeMembers, ParseTypeMember);
        ...
        public TupleTypeNode ParseTupleType()
        {
            ...
            node.ElementTypes = ParseBracketedList(Types.ParsingContext.TupleElementTypes, ParseType, SyntaxKind.OpenBracketToken, SyntaxKind.CloseBracketToken);
        ...
        public NodeArray<IJsxChild> ParseJsxChildren(/*LeftHandSide*/IExpression openingTagName)
        {
            ...
            ParsingContext |= 1 << (int)Types.ParsingContext.JsxChildren;
            while (true)
            {
        ...
        public JsxAttributes ParseJsxAttributes()
        {
            ...
            jsxAttributes.Properties = ParseList(Types.ParsingContext.JsxAttributes, ParseJsxAttribute);
        ...
        public NodeArray<IExpression> ParseArgumentList()
        {
            ...
            ParseExpected(SyntaxKind.OpenParenToken);
            var result = ParseDelimitedList(Types.ParsingContext.ArgumentExpressions, ParseArgumentExpression);
        ...
        public NodeArray<ITypeNode> ParseTypeArgumentsInExpression()
        {
            ...
            var typeArguments = ParseDelimitedList(Types.ParsingContext.TypeArguments, ParseType);
        ...
        public ArrayLiteralExpression ParseArrayLiteralExpression()
        {
            ...
            node.Elements = ParseDelimitedList(Types.ParsingContext.ArrayLiteralMembers, ParseArgumentOrArrayLiteralElement);
        ...
        public ObjectLiteralExpression ParseObjectLiteralExpression()
        {
            ...
            node.Properties = ParseDelimitedList(Types.ParsingContext.ObjectLiteralMembers, ParseObjectLiteralElement, /*considerSemicolonAsDelimiter*/ true);
        ...
        public Block ParseBlock(bool ignoreMissingOpenBrace, DiagnosticMessage diagnosticMessage = null)
        {
            ...
            if (ParseExpected(SyntaxKind.OpenBraceToken, diagnosticMessage) || ignoreMissingOpenBrace)
            {
                ...
                node.Statements = ParseList2(Types.ParsingContext.BlockStatements, ParseStatement);
        ...
        public CaseClause ParseCaseClause()
        {
            ...
            node.Statements = ParseList2(Types.ParsingContext.SwitchClauseStatements, ParseStatement);
        ...
        public SwitchStatement ParseSwitchStatement()
        {
            ...
            caseBlock.Clauses = ParseList(Types.ParsingContext.SwitchClauses, ParseCaseOrDefaultClause);
        ...
        public ObjectBindingPattern ParseObjectBindingPattern()
        {
            ...
            node.Elements = ParseDelimitedList(Types.ParsingContext.ObjectBindingElements, ParseObjectBindingElement);
        ...
        public ArrayBindingPattern ParseArrayBindingPattern()
        {
            ...
            node.Elements = ParseDelimitedList(Types.ParsingContext.ArrayBindingElements, ParseArrayBindingElement);
        ...
        public IVariableDeclarationList ParseVariableDeclarationList(bool inForStatementInitializer)
        {
            ...
            else
            {
                ...
                node.Declarations = ParseDelimitedList(Types.ParsingContext.VariableDeclarations, ParseVariableDeclaration);
        ...
        public NodeArray<HeritageClause> ParseHeritageClauses()
        {
            if (IsHeritageClause())
            {
                ...
                return ParseList(Types.ParsingContext.HeritageClauses, ParseHeritageClause);
            }
        ...
        public HeritageClause ParseHeritageClause()
        {
            ...
            if (tok == SyntaxKind.ExtendsKeyword || tok == SyntaxKind.ImplementsKeyword)
            {
                ...
                node.Types = ParseDelimitedList(Types.ParsingContext.HeritageClauseElement, ParseExpressionWithTypeArguments);
        ...
        public NodeArray<IClassElement> ParseClassMembers()
        {
            ...
            return ParseList2(Types.ParsingContext.ClassMembers, ParseClassElement);
        }
        ...
        public EnumDeclaration ParseEnumDeclaration(int fullStart, NodeArray<Decorator> decorators, NodeArray<Modifier> modifiers)
        {
            ...
            if (ParseExpected(SyntaxKind.OpenBraceToken))
            {
                ...
                node.Members = ParseDelimitedList(Types.ParsingContext.EnumMembers, ParseEnumMember);
        ...
        public INamedImportsOrExports ParseNamedImportsOrExports(SyntaxKind kind)
        {
            if (kind == SyntaxKind.NamedImports)
            {
                ...
                node.Elements = ParseBracketedList<ImportSpecifier>(Types.ParsingContext.ImportOrExportSpecifiers, ParseImportSpecifier,
            ...
            else
            {
                ...
                node.Elements = ParseBracketedList<ExportSpecifier>(Types.ParsingContext.ImportOrExportSpecifiers, ParseExportSpecifier,
                   SyntaxKind.OpenBraceToken, SyntaxKind.CloseBraceToken);
